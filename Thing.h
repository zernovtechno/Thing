...
//                                                                              // 
//                      Main tool. Classes and structures.                      //
//                     Главная утилита. Классы и структуры.                     //
//                                                                              //
//////////////////////////////////////////////////////////////////////////////////
...
class ThingClass {
public:
  String AddedHTML; //Добавленный HTML
  String SerialFrq = "115200"; //Частота связи по UART
  String DateTime = "Unknown datetime"; //Текущие дата и время
  bool DebugMode = true; //Режим отладки (вывод инфо в UART) 
